...
select * from (
       ...
       from store_sales ss
           ...
           ,date_dim
           ,cross_items 
       where ss.ss_item_sk = cross_items.ss_item_sk
         and cross_items.ss_item_sk = i_item_sk
       ...
       from catalog_sales cs
           ...
           ,date_dim
           ,cross_items
       where cs.cs_item_sk = cross_items.ss_item_sk
       ...
       from web_sales ws
           ...
           ,date_dim
           ,cross_items
       where ws.ws_item_sk = cross_items.ss_item_sk
         and ws.ws_item_sk = i_item_sk
