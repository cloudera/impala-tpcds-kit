-- start query 28 in stream 0 using template query28.tpl using seed 1201237507
select  *
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 129 and 129+10 
             or ss_coupon_amt between 2953 and 2953+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 140 and 140+10
          or ss_coupon_amt between 10031 and 10031+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 66 and 66+10
          or ss_coupon_amt between 2822 and 2822+1000
