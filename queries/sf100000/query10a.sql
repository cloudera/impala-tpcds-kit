-- start query 10 in stream 0 using template query10a.tpl using seed 1725604275
select  
  cd_gender,
  cd_marital_status,
  cd_education_status,
 ...
 where
  ...
  ca_county in ('Navajo County','Gila County','Goliad County','Box Butte County','Ionia County') and
...
-- end query 10 in stream 0 using template query10a.tpl
